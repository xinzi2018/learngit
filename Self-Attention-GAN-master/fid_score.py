...
def calculate_fid_given_paths(paths0, paths1, batch_size, cuda, dims):
    ...
    m1, s1 = _compute_statistics_of_path(paths0, model, batch_size, dims, cuda)
...
if __name__ == '__main__':
    ...
    for i in range(times):
        ...
        random_copyfile(args.path0, str1, 10000)

        # args.path0 = str1
        fid_value = calculate_fid_given_paths(str1, args.path1, args.batch_size, args.gpu != '', args.dims)
        sum = sum + fid_value
        print('FID: ', fid_value)
